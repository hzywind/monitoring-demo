...
* The original package name 'com.example.micrometer-example' is invalid and this project uses 'com.example.micrometerexample' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.1.0-SNAPSHOT/reference/htmlsingle/#actuator.metrics.export.prometheus)
